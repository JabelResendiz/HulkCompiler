...
#line 344 "parser/parser.y"
    {
        (yyval.node) = create_type_node((yyvsp[-6].var),"", (yyvsp[-4].arg_list)->args,(yyvsp[-4].arg_list)->arg_count,NULL,0,(yyvsp[-1].arg_list)->args,(yyvsp[-1].arg_list)->arg_count,0);
    }
#line 2124 "y.tab.c"
    break;
...
#line 348 "parser/parser.y"
    {
        (yyval.node) = create_type_node((yyvsp[-3].var),"",NULL,0,NULL,0,(yyvsp[-1].arg_list)->args,(yyvsp[-1].arg_list)->arg_count,0);
    }
#line 2132 "y.tab.c"
    break;
...
#line 352 "parser/parser.y"
    {
        (yyval.node) = create_type_node((yyvsp[-5].var),(yyvsp[-3].var),NULL,0,NULL,0,(yyvsp[-1].arg_list)->args,(yyvsp[-1].arg_list)->arg_count,0);
    }
#line 2140 "y.tab.c"
    break;
...
#line 356 "parser/parser.y"
    {
        (yyval.node) = create_type_node((yyvsp[-11].var),(yyvsp[-6].var),(yyvsp[-9].arg_list)->args,(yyvsp[-9].arg_list)->arg_count,(yyvsp[-4].arg_list)->args,(yyvsp[-4].arg_list)->arg_count,(yyvsp[-1].arg_list)->args,(yyvsp[-1].arg_list)->arg_count,1);
    }
#line 2148 "y.tab.c"
    break;
