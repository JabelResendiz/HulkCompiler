...
{
      -8,    18,    -8,    11,    -8,    -2,    -8,    -2,     3,     9,
      -2,    -2,    -2,    -2,    -8,    -8,    19,    19,    19,    19
};
...
{
       0,    12,     0,     4,    13,     9,     3,     9,    14,    14,
       5,     6,     7,     8,    10,    10,    14,    14,    14,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* statement: PRINT LPAREN expr RPAREN  */
#line 31 "parser.y"
                             { printf("%d\n", (yyvsp[-1].ival)); }
