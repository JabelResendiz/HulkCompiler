...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // binding_list
      // binding
      char dummy4[sizeof (std::vector<VarBinding>)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_statement_2 = 38,                      // statement_2
        S_print_stmt = 39,                       // print_stmt
        S_if_stmt = 40,                          // if_stmt
        S_expr = 41,                             // expr
        S_let_expr = 42,                         // let_expr
        S_binding_list = 43,                     // binding_list
        S_binding = 44,                          // binding
        S_let_body = 45                          // let_body
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding: // binding
        value.move< std::vector<VarBinding> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<VarBinding>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<VarBinding>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_binding_list: // binding_list
      case symbol_kind::S_binding: // binding
        value.template destroy< std::vector<VarBinding> > ();
        break;
  ...
  parser::yytranslate_ (int t) YY_NOEXCEPT
  {
    ...
    translate_table[] =
    {
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      13,    15,    31,    28,    11,    29,     2,    32,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     9,
       2,    33,     2,     2,    30,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding_list: // binding_list
      case symbol_kind::S_binding: // binding
        value.copy< std::vector<VarBinding> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding_list: // binding_list
      case symbol_kind::S_binding: // binding
        value.move< std::vector<VarBinding> > (YY_MOVE (s.value));
        break;
